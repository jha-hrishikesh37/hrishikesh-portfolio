...
function validateForm() {
	...
	var skill = document.forms["RegForm"]["skill"];
	...
	if(mobile.value == "" || !mobile.value.match(validNumber)) {
		window.alert("Please enter valid Mobile Number with country code.");
		mobile.focus();
		return false;
	}
	...
	if(skill.value == "") {
		window.alert("Please enter your Skill.");
		skill.focus();
		return false;
	}
